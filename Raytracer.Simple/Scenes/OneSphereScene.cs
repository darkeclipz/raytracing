...
namespace Raytracer.Simple.Scenes
{
    ...
    class OneSphereScene : Scene
    {
        public OneSphereScene(int width, int height) : base(width, height)
        {
        ...
        {
            Lights.Add(new SphereLight(new Vector3(10, -8, 4), 8f, new Vector3(255), new Vector3(255), 4f));
        }
